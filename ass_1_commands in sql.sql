...
-- solution ->
-- main difference between primary key and foreign key is primary key is used to show unique records in a table
--  where foreign key act as reference betweeng multiple tables.
